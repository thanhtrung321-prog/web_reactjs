        ...
        <div className="container flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block">
              ...
              />
              <CiSearch className="text-gray-500 group-hover:text-primary absolute top-1/2 -translate-y-1/2 right-3 cursor-pointer" />
            </div>
            {/* order button */}
            <button
        ...
        <ul className="sm:flex hidden items-center gap-4">
          ...
          <li className=" group relative cursor-pointer">
            <a className="flex items-center gap-[2px] py-2" href="#">
              Sản phẩm khác{" "}
              <span>
                <FaChevronDown className="transition-all duration-200 -rotate-90 group-hover:rotate-0" />
              </span>
            </a>
